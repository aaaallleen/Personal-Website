...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CFkBIlkr.js")
  },
  {
    name: "resume",
    path: "/resume",
    component: () => import("./_nuxt/resume-CwbIaEvl.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-De9IIdaL.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cgn7FfgR.js"));
